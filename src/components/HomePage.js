        ...
        <div className="some-one d-sm-flex">
          <div className="col-md-6">
            ...
            <p className="some-content py-4">
              ...
              consectetur perspiciatis nulla et dicta, rerum laboriosam
              excepturi ea assumenda. Provident repellendus blanditiis eos modi,
              neque laboriosam, recusandae quibusdam, porro laudantium
              architecto dicta rem at praesentium explicabo natus sequi tenetur
              nobis aliquam.
            </p>
